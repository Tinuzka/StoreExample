@Imports StoreAPI
@ModelType StoreAPI.ShoppingBasketItem
@Code
    ViewData("Title") = "Edit"
End Code

@If TempData("EditFailed") IsNot Nothing Then
    @<br />
    @Html.Label("Could not buy selected amount. There is " & TempData("LeftToBuy") & " items in stock.")
End If
